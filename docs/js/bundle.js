...
var _Boot = __webpack_require__(338);
...
var _graphDataStructure = __webpack_require__(344);

var _graphDataStructure2 = _interopRequireDefault(_graphDataStructure);

var _lang = __webpack_require__(345);

var _lang2 = _interopRequireDefault(_lang);

var _Hole = __webpack_require__(347);
...
var hasEdge = function hasEdge(a, b) {
  // Same row, to the right
  if (a.y === b.y && a.x - b.x === -2 * _Hole.GRID_SIZE_X) {
    return true;
  }

  // Above and within range
  if (a.y - b.y === 1 * _Hole.GRID_SIZE_Y && Math.abs(a.x - b.x) === _Hole.GRID_SIZE_X) {
    return true;
  }
...
var _class = function (_Phaser$State) {
  ...
  _createClass(_class, [{
    ...
    value: function create() {
      ...
      this.game.graph = (0, _graphDataStructure2.default)();
      this.holes = [];
      this.lines = [];
      ...
      this.holes.forEach(function (a) {
        _this2.holes.forEach(function (b) {
          if (hasEdge(a, b)) {
            _this2.buildEdge(a, b);
          }
        });
      });
    ...
    key: 'buildHole',
    value: function buildHole(x, y) {
      var _this3 = this;

      var hole = new _Hole2.default({ x: x, y: y, game: this.game, occupied: true });
      hole.events.onInputUp.add(function () {
        return _this3.onInputUp(hole);
      });
      hole.events.onInputOver.add(function () {
        return _this3.onInputOver(hole);
      });
      hole.events.onInputOut.add(function () {
        return _this3.onInputOut(hole);
      });
    ...
    key: 'buildEdge',
    value: function buildEdge(a, b) {
      this.game.graph.addEdge(a.holeId, b.holeId);
      this.game.graph.addEdge(b.holeId, a.holeId);
      this.lines.push(new _phaser2.default.Line(a.x, a.y, b.x, b.y));
    }
  }, {
    key: 'render',
    value: function render() {
    ...
    value: function onInputUp(hole) {
      ...
      if (this.game.selectedHole) {
        if (this.game.selectedHole === hole) {
          ...
          var path = this.game.graph.shortestPath(this.game.selectedHole.holeId, hole.holeId);
          if (this.validPath(path)) {
            for (var i = 0; i < path.length; i++) {
              var holeId = path[i];
              var pathHole = this.holeForId(holeId);
    ...
    key: 'onInputOver',
    value: function onInputOver(hole) {
      hole.highlighted = true;
    }
  }, {
    key: 'onInputOut',
    value: function onInputOut(hole) {
      hole.highlighted = false;
    }
  }, {
    key: 'holeForId',
    value: function holeForId(holeId) {
      return this.holes.find(function (h) {
        return h.holeId === holeId;
      });
    }
  }, {
    key: 'validPath',
    value: function validPath(path) {
      if (path.length !== 3) {
        return false;
      }

      var masterYDiff = null;
      var masterXDiff = null;

      for (var i = 0; i < path.length - 1; i++) {
        var p = this.holeForId(path[i]);
        var q = this.holeForId(path[i + 1]);

        var yDiff = p.holeY - q.holeY;
        var xDiff = p.holeX - q.holeX;
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(42), __webpack_require__(343)(module)))
...
var _idiom = __webpack_require__(346);
...
exports.GRID_SIZE_Y = exports.GRID_SIZE_X = undefined;
...
var GRID_SIZE_X = exports.GRID_SIZE_X = 40; // In pixels
var GRID_SIZE_Y = exports.GRID_SIZE_Y = 60; // In pixels
...
var _class = function (_Phaser$Sprite) {
  ...
  function _class(_ref) {
    ...
    var _this = _possibleConstructorReturn(this, (_class.__proto__ || Object.getPrototypeOf(_class)).call(this, game, x * GRID_SIZE_X, y * GRID_SIZE_Y, 'mushroom'));
    ...
    _this.selectedTween = _this.game.add.tween(_this).to({
      y: y * GRID_SIZE_Y - 2
    }, 200, _phaser2.default.Easing.Bounce.Out).to({ y: y * GRID_SIZE_Y }, 200, _phaser2.default.Easing.Bounce.Out).loop().start();
    _this.selectedTween.pause();
    return _this;
  }
